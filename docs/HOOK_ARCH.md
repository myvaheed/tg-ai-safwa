...
| Advise | Данные будущей просьбы — например, ссылки на Карточки | Пишет находку строкой в очередь Cue; перед доставкой все строки хука — одна просьба: фича готовит из их данных текст или снимает её |
