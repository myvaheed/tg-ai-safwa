...
Номера соответствуют POTENTIAL HOOKS. Название «Подцель» здесь используется в новом согласованном
смысле; сырая Идея не является пустой Целью и в проверки декомпозиции не попадает.
...
| 5. Нет Действий | Tick → Advise | Проверять потомков всей ветви; исключить сырые Идеи и завершённые/неактивные цели |
...
| 8. Похожие сущности | BeforeTool → отказ; интерактивное продолжение требует RAG-фичи | Сходство не означает идентичность; исходное создание не должно обойти ещё не полученное решение |
