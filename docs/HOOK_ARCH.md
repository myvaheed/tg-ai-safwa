...
Начало реализации, 2026-09-15; этапы 1–2 и батчи 1–8 реализованы к 2026-09-18, ревью волн 2–3
закрывается батчами Р1–Р4, онбординг — батчем 9 2026-09-24. Один реестр,
девятнадцать хуков в HOOKS: работа своя — автоматический Summary, истечение спринта, утра в
Today, ключевые Действия, уведомление онбординга перед первым ответом; отказ до тулза — Heavy
analyzer; просьбы к Advisor по факту и по времени — блокер, перегруз Today, Цели без Действий,
Hard Time, баланс энергии, отдых в Today, застрявшее в Today, повторные Missed, Дневник, дневной
итог, итог спринта, недостижимый критерий, подсказка онбординга. Хук, чей эффект доходит до
...
называются OnBeforeTurn, OnAfterTurn, OnAfterTool, OnBeforeTool, OnCommitted и OnTick, чтобы
данные случившегося события не смешивались с фильтром будущих событий.
...
| 9. Проверка исполнения | AfterRequest → HoldAnswer | Реализована: ревью ответа на сообщение владельца, один раз за запрос; включается в featuretoggles.py |
...
Ревью волн 2–3 от 2026-09-18 (B1–B3, A1) воспроизвело потерю уже
