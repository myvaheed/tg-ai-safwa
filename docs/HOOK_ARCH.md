...
|---|---|---|
| Run | Данные известной служебной операции | После хода исполняет её под фоновым lease, с проверкой актуальности и отменой; по тику — сразу, с сессиями и без чата |
...
[AG-HOOK-035](../tests/brd/tg_agent_shell/agents.feature)). Run на Committed реестр откроет
с первым потребителем — классификатором ключевых Действий.
