...
the numbers, in the background; an Action not answered about yet carries no mark, and an answer
is written only while the Action is still open in the Sprint under the title the model read;
