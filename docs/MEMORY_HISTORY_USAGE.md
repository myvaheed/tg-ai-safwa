...
- Check resolution is the one proposal screen that carries field controls. Each Pending Check offers Passed and Missed; Save appears once an answer is set, next to Discard. The model proposes which Checks to answer, never the answers.
