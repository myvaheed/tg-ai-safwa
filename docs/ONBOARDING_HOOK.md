...
Возвращение после перерыва сделано 2026-09-25 отдельно (OB-RETURN-007, AG-HOOK-048). Основание — [HOOK_ARCH.md](HOOK_ARCH.md), [AGENT_ARCH.md](AGENT_ARCH.md) и
...
нет — за владельцем. Первым проводится один факт — Ценность — руками и через
