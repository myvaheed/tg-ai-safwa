...
# Who each line of the dialogue belongs to.  The keys are the labels `_dialogue_content`
# and `split_receipts` write; the values are what a reader that did not take part sees.
CONVERSATION_TAGS = {
    "User": "User",
    "Assistant": "Advisor",
    "Summary": "Summary",
