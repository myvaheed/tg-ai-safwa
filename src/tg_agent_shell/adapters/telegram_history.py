"""The bot's chat: the Telethon reader, the note table, and what its kinds mean.

The window itself is `telegram_llm`. This is what it has to be told — which message kinds
are the conversation and what each cites — plus the two things only a running bot can
